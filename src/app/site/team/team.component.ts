...
export class TeamComponent implements OnInit {
  ...
  projectHost() {
    this.hosts = [
      {
        id: 0,
        img: 'assets/images/gallery/hosts/Bobby Pall.jpg',
        title: 'Project Lead',
        name: 'Bobby Pall',
        alt: 'African art in context photographer and project manager',
      ...
      {
        id: 1,
        img: 'assets/images/gallery/hosts/George Muiruri.jpg',
        title: 'Writer/Documentary Filmmaker',
        name: 'George Muiruri',
        alt: 'African art in context videographer',
      ...
      {
        id: 2,
        img: 'assets/images/gallery/hosts/Edna Kalumbini.jpg',
        title: 'Finance Specialist/Economist',
        name: 'Edna Kalumbini, MA',
        alt: 'African art in context finances',
      ...
      {
        id: 3,
        img: 'assets/images/gallery/hosts/Lucy Mwangi.jpg',
        title: 'Editor/Writer',
        name: 'Lucy Mwangi',
        alt: 'African art in context technical reviewer and editor',
      ...
      {
        id: 4,
        img: 'assets/images/gallery/hosts/Christine Kuriah.jpg',
        ...
        id: 5,
        img: 'assets/images/gallery/hosts/Xochitl Ramirez.jpg',
        name: 'Xochitl Ramirez',
        alt: 'African art in context designer and digital strategist',
